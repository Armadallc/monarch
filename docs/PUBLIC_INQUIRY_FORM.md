        ...
        {Array.from({ length: totalSteps }, (_, i) => (
            <div
                ...
                style={{
                    ...
                    height: "2px",
                    background:
                        i <= currentStep ? COLORS.ash : COLORS.ashSubtle,
...
export default function PublicInquiryForm() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (cleanedData.referral_source_phone) {
                cleanedData.referral_source_phone =
                    cleanedData.referral_source_phone.replace(/\D/g, "")
            }
            if (cleanedData.inquiry_type === "self") {
                cleanedData.client_first_name =
                    cleanedData.referral_source_name.split(" ")[0]
    ...
    const NextButton = ({
        ...
        <button
            onClick={onClick}
            style={{ ...btnBase, background: COLORS.ash, color: COLORS.shell }}
        >
            {label}
        </button>
    )
    ...
    const SubmitButton = () => (
        <button
            ...
            style={{
                ...btnBase,
                background: isSubmitting ? COLORS.ashSubtle : COLORS.ash,
                color: isSubmitting ? COLORS.ashMuted : COLORS.shell,
    ...
    const SuccessMessage = ({ message }: { message: string }) => (
        ...
        >
            ...
            >
                Someone from our admissions team will contact you within 24–48
                hours.
            </p>
            <button
                onClick={resetForm}
    ...
    const ErrorMessage = () => (
        <div
            style={{
                marginBottom: "24px",
                padding: "14px 20px",
                borderLeft: `3px solid ${COLORS.tangerine}`,
                background: COLORS.tangerineLight,
                fontFamily: FONT,
                fontSize: "14px",
                ...
                <div>
                    ...
                    <button
                        ...
                        onMouseOut={(e) => {
                            ;(
                                e.currentTarget as HTMLElement
                            ).style.borderColor = COLORS.ashSubtle
                        }}
                    >
                        <div
                            style={{
                ...
                <div>
                    ...
                    <div style={fieldGroup}>
                        <label style={labelStyle}>
                            Your Name{" "}
                            <span style={{ color: COLORS.tangerine }}>*</span>
                        </label>
                        <input
                            type="text"
                    ...
                    <div style={twoCol}>
                        <div style={fieldGroup}>
                            <label style={labelStyle}>
                                Phone{" "}
                                <span style={{ color: COLORS.tangerine }}>
                                    *
                                </span>
                            </label>
                            <input
                    ...
                    <div style={fieldGroup}>
                        ...
                        <input
                            type="text"
                            name="client_approximate_age"
                            value={formData.client_approximate_age}
                            onChange={handleInputChange}
                            placeholder="e.g., 35, early 40s, late 20s"
                            style={inputStyle}
                        />
                    </div>
                    ...
                    <div style={fieldGroup}>
                        ...
                        <textarea
                            ...
                            value={formData.situation_notes}
                            onChange={handleInputChange}
                            rows={4}
                            placeholder="What's going on and how can we help?"
                            style={textareaStyle}
                        />
                    </div>
                    ...
                    {submitStatus === "success" && (
                        <SuccessMessage message="Thank you for reaching out!" />
                    )}
                ...
                <div>
                    ...
                    >
                        ...
                        <div style={fieldGroup}>
                            ...
                            <input
                                type="text"
                                name="client_last_initial"
                                value={formData.client_last_initial}
                                onChange={(e) => {
                    ...
                    <div style={fieldGroup}>
                        ...
                        <select
                            name="client_current_location"
                            value={formData.client_current_location}
                            onChange={handleInputChange}
                            style={selectStyle}
                        >
                    ...
                    <div style={fieldGroup}>
                        <label style={labelStyle}>
                            Brief background / reason for referral
                        </label>
                        <textarea
                            name="situation_notes"
                            value={formData.situation_notes}
                            onChange={handleInputChange}
                            rows={4}
                            placeholder="What's the situation? Why are you reaching out?"
                            style={textareaStyle}
                        />
                    </div>
            ...
            {currentStep === 3 && (
                <div>
                    ...
                    <div style={fieldGroup}>
                        ...
                        <select
                            name="referral_source_relationship"
                            value={formData.referral_source_relationship}
                            onChange={handleInputChange}
                            style={selectStyle}
                        >
                            ...
                            <option value="probation_parole">
                                Probation / Parole Officer
                            </option>
                            <option value="case_manager">
                                Case Manager / Social Worker
                            </option>
                            <option value="mental_health_professional">
                                Mental Health Professional
                            </option>
                            <option value="medical_provider">
                                Medical Provider
                            </option>
                            <option value="other">Other</option>
                        </select>
                    ...
                    {isProfessionalRelationship && (
                        <div style={twoCol}>
                            <div style={fieldGroup}>
                                ...
                                <input
                                    type="text"
                                    name="referral_source_organization"
                                    value={
                                        formData.referral_source_organization
                                    }
                                    onChange={handleInputChange}
                                    placeholder="e.g., Denver County Court"
                                    style={inputStyle}
                                />
                            </div>
                            <div style={fieldGroup}>
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    placeholder="e.g., Public Defender"
                                    style={inputStyle}
                                />
                            </div>
                        </div>
                    ...
                    <div style={fieldGroup}>
                        ...
                        <input
                            ...
                            value={formData.how_heard_about_us}
                            onChange={handleInputChange}
                            placeholder="Google, colleague, previous referral, etc."
                            style={inputStyle}
                        />
                    </div>

                    {submitStatus === "success" && (
                        <SuccessMessage message="Thank you for your referral!" />
                    )}
                    {submitStatus === "error" && <ErrorMessage />}
