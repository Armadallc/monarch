...
const PUBLIC_SITE_HOME_URL = "https://monarchy.framer.website"
/** Public `/referrals` page — PublicInquiryForm for individuals/families (no login). */
const PUBLIC_REFERRALS_PAGE_URL = `${PUBLIC_SITE_HOME_URL}/referrals`
const REFERRAL_SOURCE_PORTAL_URL = "https://monarchy.framer.website/portal"
...
export default function ReferralForm() {
    if (typeof RenderTarget !== "undefined" && RenderTarget.current?.() === RenderTarget.canvas) {
        return (
            <div style={{ position: "relative", width: "100%", height: "400px", maxWidth: "100%", display: "flex", alignItems: "center", justifyContent: "center", background: C.coconut, fontFamily: "inherit", fontSize: "14px", color: C.textMuted, boxSizing: "border-box", padding: "24px", overflow: "hidden", flexShrink: 0 }}>
                Referral Form — view on published site
            </div>
        )
    }
        ...
        >
            ...
            {showPortal && submitStatus !== "success" && portalOnboardingReady && !needsPortalOnboarding && (
                <div>
                    <button
                        type="button"
                        onClick={() => { try { window.location.href = "https://monarchy.framer.website/portal" } catch (_e) {} }}
                        style={{
                            background: "none",
                            border: "none",
                            color: C.textMuted,
